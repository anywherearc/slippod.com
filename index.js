...
function updateDownloadLinks() {
    ...
    let downloadLinks = document.querySelectorAll('a.btn-dl')

    downloadLinks.forEach(link => {
        if (platform.os === 'windows') {
            link.href = 'https://download.slippod.com/slippod.exe'
        } else if (platform.os === 'mac') {
            link.href = 'https://download.slippod.com/slippod.dmg'
        } else if (platform.os === 'linux') {
            link.href = 'https://download.slippod.com/slippod.AppImage'
        } else {
            link.href = 'https://slippod.com/download/'
        }
    })
}
